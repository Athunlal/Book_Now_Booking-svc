...
type BookingUseCase interface {
	SearchTrain(ctx context.Context, searcheData domain.SearchingTrainRequstedData) ([]domain.Train, error)
	...
	Checkout(ctx context.Context, bookingData domain.BookingData) (domain.CheckoutDetails, error)
	...
	ViewTicket(ctx context.Context, tickets domain.Ticket) (*domain.TicketResponse, error)
